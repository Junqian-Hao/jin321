...
public class ProductSizeDetailServiceimp implements ProductSizeDetailService {
    ...
    @Override
    public Page<UpdateProductSizeDetail> getDetailBydid(int did,int pagenum,int thispage,int ptypea,int ptypeb,int ptypec) {
        productSizeDetailList=getProductSizeDetailMapper.getProductSizeDetail(did,ptypea,ptypeb,ptypec);
    ...
    public int updateDetail(UpdateProductSizeDetail updateProductSizeDetail) {
        ...
        if(product!=null&&productsize!=null){
            ...
            log.info(updateProductSizeDetail.toString());
            CacheUtil.flushDb();
